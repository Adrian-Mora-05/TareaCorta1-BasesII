...
Antes de seguir, te quiero recordar el panorama de lo que llevamos por el momento, los siguientes archivos y carpetas: carpeta 'api': * carpeta 'coverage' * carpeta 'node_modules' * carpeta 'src': * - carpeta 'config': db.js, mongo.js, swagger.js * - carpeta 'controllers': auth.controller.js, menus.controller.js, orders.controller.js, reservations.controller.js, restaurants.controller.js, users.controller.js * - carpeta 'dao': * -- subcarpeta 'interfaces': reservationDAO.js * -- subcarpeta 'mongodb': reservation.dao.mongo.js, restaurant.dao.mongo.js * -- subcarpeta 'postgres': reservation.dao.postgres.js, restaurant.dao.postgres.js * -- DAOFactory.js * - carpeta 'middlewares': auth.js, roles.js * - carpeta 'routes': auth.routes.js, menus.routes.js, orders.routes.js, reservations.routes.js, restaurants.routes.js, users.routes.js * - carpeta 'services': auth.service.js, menus.service.js, orders.service.js, reservations.service.js, restaurants.service.js, users.service.js * - carpeta 'tests': controllers.test.js * - app.js * - server.js * carpeta 'tests' * - carpeta 'integration': auth.integration.test.js, menus.integration.test.js, orders.integration.test.js, reservations.integration.test.js, restaurants.integration.test.js, users.integration.test.js * - carpeta 'unit' : auth.controller.test.js, auth.service.test.js, menus.controller.test.js, orders.controller.test.js, orders.service.test.js, reservations.controller.test.js, reservations.service.test.js, restaurants.controller.test.js, roles.middleware.test.js, users.controller.test.js, users.service.test.js * babel.config.json * dockerfile * jest.setup.js * package-lock.json * package.json carpeta 'db': carpeta 'init' con: 01_schema.sql, 02_tablas.sql, 03_funciones.sql, 04_seed.sql carpeta 'keycloak': realm-export.json carpeta 'node_modules' .env .gitattributes .gitignore docker-compose.yml package-lock.json package.json README.md Comencemos con lo de DAO, pero además te comparto el instructivo completo (siguen siendo los mismos endpoints):
